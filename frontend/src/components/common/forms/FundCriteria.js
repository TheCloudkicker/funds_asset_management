...
const FundCriteria = ({ dispatch, formObj }) => {
    ...
    const onClick = () => {
        ...
        dispatch(saveCriteria(criterias, formObj.value))

    }

    return (
        <React.Fragment>
            <Modal.Header>{capitalizeFirstLetter(formObj.value)} Criteria</Modal.Header>
